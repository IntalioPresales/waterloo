                ...
                options: [
                    {
                        ...
                        // Add title
                        title: {
                            text: 'Legal Matters Distribution',
                            subtext: '',
                            x: 'center'
                        },
                        ...
                        legend: {
                            x: 'left',
                            orient: 'vertical',
                            data: ['Breach of contract', 'Personal injury', 'Adoption ', 'Patent prosecution', 'Copyright enforcement']
                        },
                        ...
                        series: [{
                            ...
                            radius: '60%',
                            data: [
                                { value: idx * 128 + 80, name: 'Breach of contract' },
                                { value: idx * 64 + 160, name: 'Personal injury' },
                                { value: idx * 32 + 320, name: 'Adoption ' },
                                { value: idx * 16 + 640, name: 'Patent prosecution' },
                                { value: idx++ * 8 + 1280, name: 'Copyright enforcement' }
                            ]
                        }]
                    },
